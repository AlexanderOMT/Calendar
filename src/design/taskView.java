 ...
 * @author TESTER
 */
public class taskView extends javax.swing.JDialog {
    ...
    public taskView(Task t) {
        ...
        jLabel2.setText(t.getDesc());
        jLabel3.setText(t.getDate().getYear()+1900 + "-" + t.getDate().getMonth() + "-" +
                        t.getDate().getDate() + " " + t.getDate().getHours() + ":" +
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Name task");

        jLabel2.setText("Desc task");

        jLabel3.setText("Hour task");

        jLabel4.setText("Tag task");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            taskView dialog = new taskView(new javax.swing.JFrame(), true);
