...
public class Share extends javax.swing.JDialog implements usuario{
    ...
    public void changeColor(){
        if(userSignedUpmp.getModo() == 1){
            ...
            Rol.getEditor().getEditorComponent().setBackground(Color.decode("#000000"));
            Rol.getEditor().getEditorComponent().setForeground(Color.decode("#FFFFFF"));
            ...
            Rol.getEditor().getEditorComponent().setBackground(Color.decode("#FFFFFF"));
            Rol.getEditor().getEditorComponent().setForeground(Color.decode("#000000"));
            // jButton1.setBackground(Color.decode("#859EBC"));
     ...
     public void loadNotifications() throws SQLException{
        ...
        if(invitations.size() >0){ 
            ...
            for (int x=0; x<invitations.size(); x++){
               ...
               // El texto no funciona, no cambia de color
                if(userSignedUpmp.getModo() == 1){
                    ...
                    roles.getEditor().getEditorComponent().setBackground(Color.decode("#000000"));
                    roles.getEditor().getEditorComponent().setForeground(Color.decode("#FFFFFF"));

                    title.setBackground(Color.decode("#FFFFFF"));
                    rol_user.setBackground(Color.decode("#FFFFFF"));
                }else{
                    ...
                    roles.getEditor().getEditorComponent().setBackground(Color.decode("#FFFFFF"));
                    roles.getEditor().getEditorComponent().setForeground(Color.decode("#000000"));

                    title.setBackground(Color.decode("#000000"));
                    rol_user.setBackground(Color.decode("#000000"));
                }
